# -*- coding: utf-8 -*-
EJ = '''amaga Contemplo. contempló Cigüeña. Utilizando el módulo pattern.es defina una función denominada verbosInfinitivos que reciba un string, el cual puede contener varias oraciones y devuelva una lista de los verbos en infinitivo. hago, baila, voy, hacía, hice '''
...
#C:\Users\Coya\AppData\Local\Programs\Python\Python36
